...
function Userquestion() {
  ...
  const handleOnClick = async () => {
     ...
     // console.log("Submitted");
      ...
      fetch('http://localhost:5000/userquestion', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
    ...
    <Zoom in={true} timeout={1000}>
      <div>
        ...
        >
          ...
          {/*Question 2*/}
          <Container className={classes.container} style={{ padding: 20 }}>
            <InputLabel id="label">2. On a scale of 1-10 how would you rank your mental state? With 1 being the worst in your lifetime 
            and 10 being the best in your lifetime.</InputLabel>
            </Container>
            <Container className={classes.container} style={{ padding: 20 }}>
        ...
        {/*Question 3*/}
        <Container className={classes.container} style={{ padding: 20 }}>
            <InputLabel id="label">3. How would you rate your overall 
            progress/productivity for your day’s goals?</InputLabel>
            </Container>
            <Container className={classes.container} style={{ padding: 20 }}>
